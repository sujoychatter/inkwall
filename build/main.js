...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wrapper = __webpack_require__(197);
	var Home = __webpack_require__(199);
	var NewPost = __webpack_require__(200);


	//Elements generated with wrapper
	var HomeWrapperElement = React.createClass({displayName: "HomeWrapperElement",
		render: function () {
			return (
				React.createElement(Wrapper, {child: Home, cssElementId: "home-css", stylesheetLink: "/stylesheets/home.css"})
			)
		}
	});
	var NewPostWrapperElement = React.createClass({displayName: "NewPostWrapperElement",
		render: function () {
			return (
				React.createElement(Wrapper, {child: NewPost, cssElementId: "new-post-css", stylesheetLink: "/stylesheets/new-post.css"})
			)
		}
	})
	//
	...
	var routes = (
		React.createElement(Route, null, 
			React.createElement(Route, {name: "home", path: "/", handler: HomeWrapperElement}), 
			React.createElement(Route, {name: "new_post", path: "new_post", handler: NewPostWrapperElement})
		)
	);


	Router.run(routes, Router.HistoryLocation, function (Handler) {
		React.render(React.createElement(Handler, null), document.getElementById('application'));
	});
		...
		render: function () {
			if (this.state.user) {
				var userData = {
					...
					image = React.createElement("div", {className: "user-image", style: divStyle});
				var logout = React.createElement("a", {className: "login-button", href: "/logout"}, "Logout")
			}
			else {
				var login = React.createElement("a", {className: "login-button", href: "/auth/facebook"}, "Login")
			}
			return (
				React.createElement("div", {className: "header"}, 
					React.createElement("img", {src: "/images/logo.png", type: "image/png"}), 
					React.createElement("span", {className: "site-details"}, 
						React.createElement("span", {className: "site-name", itemProp: "name"}, "Fodoo"), 
						React.createElement("span", {className: "site-about", itemProp: "description"}, "Blog for engineers")
					), 
					React.createElement("span", {className: "pull-right right-elements"}, 
						image, 
						login, 
						logout
					)
		...
		render: function () {
			return (
				React.createElement("div", {className: "container home"}, 
					...
					React.createElement("h1", null, "Fodoo is under construction")
				)
			)
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ExecutionEnvironment = __webpack_require__(52);
	var Button = __webpack_require__(201);
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function () {
			return (
				React.createElement("div", {className: "new-post container"}, 
					React.createElement("div", {className: "title"}, 
						React.createElement("input", {type: "text", className: "new-blog-title", placeholder: "Blog Title"})
					), 
					React.createElement("div", {className: "tinymce"}, 
						React.createElement("div", {className: "dummy-container"})
					), 
					React.createElement(Button, {classes: "btn btn-primary save", content: "Save", onclicking: this.saveContent}), 
					React.createElement(Button, {classes: "btn btn-primary publish", content: "Publish"})
				)
			)
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function () {
			return (
				React.createElement("button", {className: this.props.classes, onClick: this.clicked}, this.props.content)
			)
		}
	});
