...
var show_keys = ['name', 'photo', 'admin', 'id', 'profile_id', "photo_large"]
var user_show_keys = ['name', 'photo', 'admin', 'id', 'email', "profile_id", "photo_large"]
var admin_show_keys = ['name', 'photo', 'admin', 'id', 'email', "profile_id", "photo_large"]

var user_editable_keys = ['email', 'name']
var admin_editable_keys = ['email', 'name', 'admin', 'photo']
module.exports = {
	find: function(id, user){
		var keys = user && user.admin ? admin_show_keys : (user && user.id == id ? user_show_keys : show_keys )
